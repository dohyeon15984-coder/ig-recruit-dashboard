...
const DEMO_POSTS = [
  { id: 'demo_1', caption: '2027 상반기 신입 공채 시작! 지금 바로 지원하세요 📢', media_type: 'CAROUSEL_ALBUM', category: '채용공고', daysAgo: 55, like_count: 210, comments_count: 8, saved: 34, shares: 6, reach: 8200, views: 8200 },
  ...
  { id: 'demo_5', caption: '채용설명회 현장 스케치 (feat. 인사팀)', media_type: 'CAROUSEL_ALBUM', category: '교육', daysAgo: 43, like_count: 150, comments_count: 5, saved: 12, shares: 3, reach: 5100, views: 5100 },
  ...
  { id: 'demo_7', caption: '채용 공고 마감 D-3 놓치지 마세요', media_type: 'CAROUSEL_ALBUM', category: '채용공고', daysAgo: 37, like_count: 180, comments_count: 4, saved: 20, shares: 9, reach: 7600, views: 7600 },
  ...
  { id: 'demo_12', caption: '2027 하반기 공채 예고', media_type: 'CAROUSEL_ALBUM', category: '채용공고', daysAgo: 22, like_count: 240, comments_count: 11, saved: 41, shares: 12, reach: 8900, views: 8900 },
  ...
  { id: 'demo_15', caption: '사내 동아리 소개: 러닝크루 편', media_type: 'CAROUSEL_ALBUM', category: '조직문화', daysAgo: 9, like_count: 260, comments_count: 14, saved: 30, shares: 7, reach: 6400, views: 6400 },
  ...
  // 프로필 방문/팔로우는 릴스(VIDEO)에서는 API가 안 줘서 null
  profile_visits: p.media_type === 'VIDEO' ? null : Math.round((p.reach || 0) * 0.02),
  follows: p.media_type === 'VIDEO' ? null : Math.round((p.reach || 0) * 0.001),
  permalink: '#',
  thumbnail_url: null,
